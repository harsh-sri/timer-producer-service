    ...
    describe('hours', () => {
        it('should throw an error if hours is not an integer', async() => {
            ...
            try {
                ...
                expect(error).toBeUndefined();
                expect(result).toBeDefined();
                expect(instanceToPlain(result[0].constraints.min)).toEqual('hours must not be less than 0');
                expect(instanceToPlain(result[0].constraints.isInt)).toEqual('hours must be an integer number');
            }
        });
        ...
        it('should throw an error if hours is not defined', async () => {
            ...
            try {
                ...
                expect(error).toBeUndefined();
                expect(result).toBeDefined();
                expect(instanceToPlain(result[0].constraints.isDefined)).toEqual('hours should not be null or undefined');
                expect(instanceToPlain(result[0].constraints.min)).toEqual('hours must not be less than 0');
                expect(instanceToPlain(result[0].constraints.isInt)).toEqual('hours must be an integer number');
            }
        });
    ...
    describe('minutes', () => {
        it('should throw an error if minutes is not an integer', async () => {
            ...
            try {
                ...
                expect(error).toBeUndefined();
                expect(result).toBeDefined();
                expect(instanceToPlain(result[0].constraints.min)).toEqual('minutes must not be less than 0');
                expect(instanceToPlain(result[0].constraints.isInt)).toEqual('minutes must be an integer number');
            }
        });
        ...
        it('should throw an error if minutes is not defined', async () => {
            ...
            try {
                ...
                expect(error).toBeUndefined();
                expect(result).toBeDefined();
                expect(instanceToPlain(result[0].constraints.isDefined)).toEqual('minutes should not be null or undefined');
                expect(instanceToPlain(result[0].constraints.min)).toEqual('minutes must not be less than 0');
                expect(instanceToPlain(result[0].constraints.isInt)).toEqual('minutes must be an integer number');
            }
        });
    ...
    describe('seconds', () => {
        it('should throw an error if seconds is not an integer', async () => {
            ...
            try {
                ...
                expect(error).toBeUndefined();
                expect(result).toBeDefined();
                expect(instanceToPlain(result[0].constraints.min)).toEqual('seconds must not be less than 0');
                expect(instanceToPlain(result[0].constraints.isInt)).toEqual('seconds must be an integer number');
            }
        });
        ...
        it('should throw an error if seconds is not defined', async () => {
            ...
            try {
                ...
                expect(error).toBeUndefined();
                expect(result).toBeDefined();
                expect(instanceToPlain(result[0].constraints.isDefined)).toEqual('seconds should not be null or undefined');
                expect(instanceToPlain(result[0].constraints.min)).toEqual('seconds must not be less than 0');
                expect(instanceToPlain(result[0].constraints.isInt)).toEqual('seconds must be an integer number');
            }
        });
    ...
    describe('webhookUrl', () => {
        it('should throw an error if webhookUrl is not a valid url', async () => {
            ...
            try {
                ...
                expect(error).toBeUndefined();
                expect(result).toBeDefined();
                expect(instanceToPlain(result[0].constraints.isUrl)).toEqual('webhookUrl must be a URL address');
        ...
        it('should throw an error if webhookUrl is not defined', async () => {
            ...
            try {
                ...
                expect(result).toBeDefined();
                expect(instanceToPlain(result[0].constraints.isUrl)).toEqual('webhookUrl must be a URL address');
                expect(instanceToPlain(result[0].constraints.isDefined)).toEqual('webhookUrl should not be null or undefined');
            }
        });
    });
})